...
const ProblemData = {
       ...
       1: {
        ...
        output_Statement: "Ouput the string \(S\). ",
        ...
        output_Statement: "Ouput the maximum element in \(A\). ",
   ...
   return(
        ...
        <Container className="p-4">
            ...
            <div className="text-center">
             <h3> {problem.title} </h3>
             <span> {`time limit per test: ${problem.time_limit} seconds`} </span> <br></br>
    ...
    <Row>
      ...
      <Col md={6}>
        <Table bordered square style={{ marginBottom: 0 }}>
          ...
          <Row>
            <Col>
           <h5 style={{display:"inline"}}>Ratings:</h5><Difficulty rating={problem.ratings.rating} fill={problem.ratings.fill} color={problem.ratings.color}/><br></br><br></br>
           <h5 style={{display:"inline"}}>Tags: </h5>{problem.tags?.map((tag) => (
